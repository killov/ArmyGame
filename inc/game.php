...
<head>
	...
	<style>
		...
		//$hour = 12;
		if($hour<6 || $hour>21){
			echo '#back{background: #27411A}
			.mapblok div {
    background: url("img/mapa/FULL_MAP_TIME1.png") no-repeat;
    background-size: 3150%;}';
		} elseif($hour<10 || $hour>15){
			echo '#back{background: #66943E} .mapblok div {
    background: url("img/mapa/FULL_MAP_TIME2.png") no-repeat;
    background-size: 3150%;}';

		} elseif($hour<11 || $hour>12){
			echo '#back{background: #72A645} .mapblok div {
    background: url("img/mapa/FULL_MAP_TIME3.png") no-repeat;
    background-size: 3150%;}';

		} else{
			echo '#back{background: #72A645} .mapblok div {
    background: url("img/mapa/FULL_MAP_TIME4.png") no-repeat;
    background-size: 3150%;}';
		}
	...
	<link rel="stylesheet" href="styleg.css?v001" type="text/css">
	<script type="text/javascript" src="js/jquery-2.1.3.min.js"></script>
	<script src="js/jquery-ui.min.js"></script>
	<script src="js/jquery.mousewheel.min.js"></script>

	<script type="text/javascript" src="js/script.js?v001"></script>
	<meta charset="UTF-8">
	<script>
		$(function () {
			$(document).tooltip({
...
<div id="header">
	...
	<div id="h">
		...
		<div id="hornimenu">
			<ul>
				<li class="mesto">
					<a href="#" onMouseDown="page_load('mesto')" onMouseUp="page_draw()"
					   title="<?php echo $lang[25]; ?>"> </a>
				</li>
				<li class="mapa">
					<a href="#" onClick="mapa()" title="<?php echo $lang[66]; ?>"> </a>
				</li>
				<li class="stat">
					<a href="#" onMouseDown="page_load('statistika')" onMouseUp="page_draw()"
					   title="<?php echo $lang[58]; ?>"></a>
				</li>
				<li class="zpravy<?php if ($user["zprava"]) {
					echo " zpravyn";
				} ?>">
					<a href="#" onMouseDown="page_load('zpravy')" onMouseUp="page_draw()"
					   title="<?php echo $lang[41]; ?>"></a>
				</li>
		...
		<div id="suroviny">
			<div class="surovina" id="drevoc" title="">
				...
				<div>
					<span
						id="drevo"><?php echo surovina($mesto["drevo"], $mesto["drevo_produkce"], $mesto["suroviny_time"], $mesto["sklad"], time()); ?></span>
				</div>
				<div class="hidden">
			...
			<div class="surovina" id="kamenc" title="">
				...
				<div>
					<span
						id="kamen"><?php echo surovina($mesto["kamen"], $mesto["kamen_produkce"], $mesto["suroviny_time"], $mesto["sklad"], time()); ?></span>
				</div>
				<div class="hidden">
			...
			<div class="surovina" id="zelezoc" title="">
				...
				<div>
					<span
						id="zelezo"><?php echo surovina($mesto["zelezo"], $mesto["zelezo_produkce"], $mesto["suroviny_time"], $mesto["sklad"], time()); ?></span>
				</div>
				<div class="hidden">
			...
			<div class="surovina" id="obilic" title="">
				...
				<div>
					<span
						id="obili"><?php echo surovina($mesto["obili"], $mesto["obili_produkce"], $mesto["suroviny_time"], $mesto["sklad"], time()); ?></span>
				</div>
				<div class="hidden">
	...
	<div id="p">
		<ul>
			<li class="profil">
				<a href="#" onMouseDown="page_load('profil')" onMouseUp="page_draw()"
				   title="<?php echo $lang[33]; ?>"></a>
			</li>
			<li class="logout">
				<a href="?odhlas"> </a>
			</li>
